...
#   docker build -t cypress/included:11.2.0 .
#
...
RUN echo "whoami: $(whoami)" \
  ...
  && npm install -g '@badeball/cypress-cucumber-preprocessor@20.0.7' \
  && npm install -g '@shelex/cypress-allure-plugin@2.40.0' \
  && npm install -g 'cypress-mochawesome-reporter@3.5.1' \
  && npm install -g 'cypress-visual-regression@5.0.2' \
